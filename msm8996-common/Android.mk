...
include $(CLEAR_VARS)
LOCAL_MODULE := vendor.lge.hardware.lgatcmd-V1.0-java
LOCAL_MODULE_OWNER := lge
LOCAL_SRC_FILES := proprietary/framework/vendor.lge.hardware.lgatcmd-V1.0-java.jar
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := JAVA_LIBRARIES
LOCAL_MODULE_SUFFIX := .jar
...
include $(CLEAR_VARS)
LOCAL_MODULE := vendor.lge.hardware.lpwg-V1.0-java
LOCAL_MODULE_OWNER := lge
LOCAL_SRC_FILES := proprietary/framework/vendor.lge.hardware.lpwg-V1.0-java.jar
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := JAVA_LIBRARIES
LOCAL_MODULE_SUFFIX := .jar
